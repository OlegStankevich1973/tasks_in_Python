...
# text_in = 'ОООООООООРРРОРОРРРРРРР'
# print('Входные данные: ', text_in)

text_count = ""  # пустая строка, куда будем записывать комбинации подряд выпавших решек
...
# список чисел подряд выпавших решек
print('Список чисел подряд выпавших решек', numbers)

if 'Р' not in text_in:
    print('Решек нет. Ответ: 0')
